Made a golang ecommerce backend project which provides all the necessary api's required for an ecommerce site
...
```json
{
  ...
  "created_at": "2023-04-09T08:14:11Z",
  "updtaed_at": "2023-04-09T08:14:11Z",
